          ...
          <Table>
            <TableHeader className='bg-muted/50'>
              <TableRow className='hover:bg-transparent border-border'>
                <TableHead className='py-8 px-8 font-black uppercase text-[12px] tracking-[0.2em] text-muted-foreground'>購買日期</TableHead>
                <TableHead className='py-8 font-black uppercase text-[12px] tracking-[0.2em] text-muted-foreground'>訂單編號</TableHead>
                <TableHead className='py-8 font-black uppercase text-[12px] tracking-[0.2em] text-muted-foreground'>訂單狀態</TableHead>
                <TableHead className='text-right py-8 px-8 font-black uppercase text-[12px] tracking-[0.2em] text-muted-foreground'>總額</TableHead>
                <TableHead className='text-right py-8 px-8 font-black uppercase text-[12px] tracking-[0.2em] text-muted-foreground'>訂單內容</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {orders.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={5} className='h-80 text-center'>
                    <div className='flex flex-col items-center gap-3'>
                      ...
                      <p className='text-muted-foreground font-bold text-xl'>目前尚無任何訂單紀錄</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : (
