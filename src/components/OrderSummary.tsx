      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
        <div className="space-y-8">
          <div>
            ...
            <div className="space-y-3">
              {specs.map((spec, i) => (
                <div
                  key={i}
                  className="flex justify-between items-center border-dashed border-border pb-2 text-sm"
                >
          ...
          <div>
            ...
            <div className="bg-primary/[0.03] rounded-2xl p-4 border border-primary/10 text-sm">
          ...
          <div>
            ...
            <div className="bg-muted/30 rounded-2xl p-4 border border-border/50 text-sm">
              ...
              <div className="mt-4">
                ...
                <p className="font-bold text-foreground">
                  {order?.invoiceType === "ELECTRONIC" && "個人電子載具"}
                  {order?.invoiceType === "COMPANY" &&
                    `公司三聯 (${order?.companyTitle || "未填寫抬頭"})`}
                  {order?.invoiceType === "PAPER" && "個人紙本發票"}
                </p>

                {order?.invoiceType !== "PAPER" && (
          ...
          <div>
            ...
            <div className="bg-muted/30 rounded-2xl p-5 border border-border/50 text-sm">
              <p className="text-foreground font-black text-base">
                {order?.shippingAddress?.name || "未填寫"}
              </p>
              ...
              <p className="text-primary font-bold mt-3 text-base">
                {order?.shippingAddress?.phoneNumber || "未提供電話"}
              </p>
            </div>
          </div>
